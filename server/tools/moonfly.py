...
class ProtoGen(object):
    ...
    def gen_cmdcode(self, startid=1):
        ...
        charp_cmdcodetype_content = ""
        charp_typecmdcode_content = ""
        forward_content = ""
        ...
        for cmd in order_list:
            ...
            charp_cmdcode_content += "    " + \
                "public const ushort " + cmd + " = " + str(startid) + ";\n"
            charp_cmdcodetype_content += "        " + \
                "{CmdCode." + cmd + ",typeof(" + cmd + ")},\n"
            charp_typecmdcode_content += "        " + \
                "{typeof(" + cmd + ")," + "CmdCode." + cmd + "},\n"
            startid += 1
        ...
        with open(self.config.csharp_cmd_file, "w", encoding='utf-8') as fobj:
            fobj.write(csharp_cmdcode_template % (
                charp_cmdcodetype_content, charp_typecmdcode_content, charp_cmdcode_content))
...
config = Config(
    ...
    csharp_out_dir="../../BallAction/Assets/Hotfix/Proto",
    csharp_cmd_file="../../BallAction/Assets/Hotfix/Proto/CmdCode.cs",
